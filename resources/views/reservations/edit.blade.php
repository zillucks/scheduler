                ...
                <div class="col-8">
                    ...
                    <div class="card">
                        <div class="card-header bg-white clearfix">
                            <h4 class="card-title float-left">Edit Class</h4>
                            <div class="float-right">
                                <a href="{{ route('classes') }}" class="btn btn-sm btn-danger"><i class="fas fa-times"></i></a>
                            </div>
                        </div>
                        <div class="card-body">
                            <form action="{{ route('classes.update', $class->slug) }}" method="POST" id="form-update-classes">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <input
                                            ...
                                            name="class_name"
                                            id="class_name"
                                            class="form-control {{ $errors->has('class_name') ? 'is-invalid' : '' }}"
                                    ...
                                    <div class="col-sm-6">
										<select name="site_id" id="site_id" class="form-control {{ $errors->has('site_id') ? 'is-invalid' : '' }}">
											...
											@foreach ($sites as $key => $value)
												<option value="{{ $key }}" {{ $class->site_id === $key ? 'selected' : '' }}>{{ $value }}</option>
											@endforeach
										</select>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6 col-md-4 input-group">
										<input
											...
											name="max_quotes"
											id="max_quotes"
											class="form-control {{ $errors->has('max_quotes') ? 'is-invalid' : '' }}"
											value="{{ $class->max_quotes }}">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-check">
                                            <input type="checkbox" name="class_status" id="class_status" class="form-check-input" value="1" {{ $class->class_status ? 'checked' : '' }}>
                                            <label class="form-check-label" for="class_status">{{ $class->class_status ? 'Aktif' : 'Tidak Aktif' }}</label>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group row">
