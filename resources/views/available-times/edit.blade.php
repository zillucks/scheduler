            ...
            <div class="col-6">
                ...
                <div class="card">
                    <div class="card-header bg-wite">
                        <h5 class="card-title float-left">Edit Times</h5>
                    ...
                    <div class="card-body">
                        <form action="{{ route('available-times.update', $time->id) }}" method="POST" id="form-add-times">
                            @csrf
                            <input type="hidden" name="_method" value="PUT">
                            <div class="form-group row">
                                <label for="start_time" class="col-form-label col-sm-6 col-md-4">Start Time</label>
                                <div class="col-sm-6 col-md-4">
                                    <input type="time" name="start_time" id="start_time" class="form-control {{ $errors->has('start_time') ? 'is-invalid' : '' }}"
                                        required value="{{ $time->start_time }}"> @if ($errors->has('start_time'))
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6 col-md-4">
                                    <input type="time" name="end_time" id="end_time" class="form-control {{ $errors->has('end_time') ? 'is-invalid' : '' }}"
                                        required value="{{ $time->end_time }}"> @if ($errors->has('end_time'))
