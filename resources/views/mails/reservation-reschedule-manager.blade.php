...
<body>
    <main>
        ...
        <p>Kami informasikan bahwa staff Bapak / Ibu a.n. {{ $reservation->identity->full_name }} telah melakukan perubahan jadwal training <b>{{ $reservation->training->training_name }} yang sebelumnya pada tanggal {{ $old_reservation['reservation_date'] }} menjadi {{ $reservation->reservation_date }}</b></p>
