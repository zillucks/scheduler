                ...
                <div class="col-8">
                    ...
                    <div class="card">
                        <div class="card-header bg-white clearfix">
                            <h4 class="card-title float-left">Add Department</h4>
                            <div class="float-right">
                                <a href="{{ route('departments') }}" class="btn btn-sm btn-danger"><i class="fas fa-times"></i></a>
                            </div>
                        </div>
                        <div class="card-body">
                            {!! Form::open(['method' => 'post', 'route' => 'departments.save', 'id' => 'form-add-departments']) !!}
                            <div class="row">
                                <div class="form-group col-8">
                                    {!! Form::text('department_name', old('department_name'), ['class' => $errors->has('department_name') ? 'form-control is-invalid' : 'form-control',
                                ...
                                <div class="form-group col-8">
                                    <div class="btn-group btn-group-sm">
                                        ...
                                        <a href="{{ route('departments') }}" class="btn btn-danger" id="btn-back">
