                ...
                <form method="post" enctype="multipart/form-data">
                    ...
                    <div class="card">
                        <div class="card-header bg-white">
                            <h5 class="card-title float-left">Import Data Department</h5>
                            <div class="float-right">
                                <a href="{{ route('departments.download', 'xlsx') }}" class="btn btn-sm btn-square btn-info"><i class="fas fa-file-excel-o"></i> Download Xlsx Template</a>
